...
This guide will teach you how to harden your Fedora install by taking advantage of the Timeshift BTRFS snapshots. As of right now, this is confirmed to work up until Fedora 42.
...
I will not take responsibility if this guide breaks your current installation or harms in anyway.
...
Choose "sda2" as your snapshot location. You can also use an external device or any other location to save your snapshot in. Preferably an external location in case your harddrive might fail. In this case I will choose my primary drive that I have installed Fedora on.
...
I'm gonna install and set up grub-btrfs in order to boot into a snapshot in read-only mode from the grub menu in order to roll back to a certain snapshot in Timeshift if needed.
